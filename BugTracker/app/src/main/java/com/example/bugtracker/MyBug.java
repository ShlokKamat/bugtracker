...
public class MyBug extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseHelper2 databaseHelper2 = new DatabaseHelper2(MyBug.this);
        List<BugModel> allbugs = databaseHelper2.getMyBugs(Login.usernametxt);
        ArrayAdapter bugArrAdap = new ArrayAdapter<BugModel>(MyBug.this, android.R.layout.simple_list_item_1,allbugs);
